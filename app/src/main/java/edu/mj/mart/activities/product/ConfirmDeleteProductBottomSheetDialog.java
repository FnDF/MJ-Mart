...
public class ConfirmDeleteProductBottomSheetDialog extends BottomSheetDialogFragment {
    ...
    public ConfirmDeleteProductBottomSheetDialog(OnCIListener listener) {
